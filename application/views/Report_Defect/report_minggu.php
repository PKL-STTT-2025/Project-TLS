<div class="container py-4">
    ...
    <h2 class="text-center mb-4 fw-bold">Report Mingguan</h2>

    <!-- Ringkasan -->
    <div class="row justify-content-center mb-4">
        <div class="col-md-4">
            <div class="card shadow-sm p-4 text-center bg-light border-0">
                <h6 class="text-muted mb-2" style="font-size: 16px;">Total Defect / Week</h6>
                <h2 class="text-danger fw-bold mb-0" style="font-size: 36px;">
                    <?= isset($total_defect) ? $total_defect : '-' ?>
                </h2>
            </div>
        </div>
    </div>
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            <label class="fw-semibold">Line:</label>
            <select class="form-control shadow-sm" name="Workgroup" id="Workgroup" required>
        ...
        <div class="col-md-6">
            <label class="fw-semibold">Style:</label>
            <select class="form-control shadow-sm" name="style" id="style" required>
